...
struct _home {
        ...
        int       NumForceCall;   /* number of calls to NodeForce() function */
 ...
 */
        ...
        RemoteDomain_t  **remoteDomainKeys; /* pointers to RemoteDomain_t    */
                                            ...
                                            /* domains                       */
/*
 *		Structures for the mobility law Jacobian. We use the coordinate method
 *		for storing the Jacobian in a sparse way. This requires an array of
 *		matrix values, Jval, an array of row numbers for those values, Jrow, 
 *		and an array of column numbers, Jcol.
 */
//#define MAX_J_SIZE 1000 //temporary maximum Jacobian size to avoid malloc calls
		...
		Implicit_t *implicit;
#endif
		//int			dof_list[MAX_J_SIZE];	/*array listing dof assignments*/
