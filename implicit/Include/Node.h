...
#ifdef _IMPLICIT
	int		ndof;		/*number of degrees of freedom (implicit solver)*/
	int		dofx, dofy, dofz;		/*degree of freedom numbers (implicit solver)*/
	real8	Q11,Q12,Q13,Q21,Q22,Q23,Q31,Q32,Q33;	/*transformation matrix for node local coord system*/
	 	 	 	 	 	 	 	 	 	 	 	 	 	 	 	 /*(implicit solver)*/	
#endif
