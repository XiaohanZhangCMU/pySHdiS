...
#define FTYPE_FCC_LOOP		6
#define FTYPE_FCC_LINE_LOOP		7
#define FTYPE_FCC_PERFECT_LOOP	8
#define FTYPE_EDGE		9
#define FTYPE_MAX		10
...
#define FNAME_FCC_LOOP		"fcc-loop"
#define FNAME_FCC_LINE_LOOP		"fcc-line-loop"
