					   ...
					   real8 *fp4x, real8 *fp4y, real8 *fp4z)
{
  ...
  *fp4z = 0.0;
  ...
  //bug : shape=0.5e0*magdiff/(fabs(temp1)*tanthetac);
  ...
  */
  ...
  printf("  f3 = %20e %20e %20e\n", f3[0],f3[1],f3[2]);
  printf("  f4 = %20e %20e %20e\n",f4[0],f4[1],f4[2]);
  ...
  *fp4z = shapemid*f4[2];
  ...
  printf("  f3a = %20e %20e %20e\n", fp3xcor,fp3ycor,fp3zcor);
  printf("  f4a = %20e %20e %20e\n", fp4xcor,fp4ycor,fp4zcor);
  ...
  *fp4z += shapea*fp4zcor;
  ...
  printf("  f3b = %20e %20e %20e\n", fp3xcor,fp3ycor,fp3zcor);
  printf("  f4b = %20e %20e %20e\n", fp4xcor,fp4ycor,fp4zcor);
